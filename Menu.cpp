...
void Menu::Draw() {
	...
	if (renditionTime < 30) {
		DrawFormatStringToHandle(240, 300, GetColor(255, 255, 255), fontHandle[0], "SPACEでスタート");
		DrawFormatStringToHandle(240, 360, GetColor(255, 255, 255), fontHandle[0], "Tでチュートリアル");
	}
	else {
		DrawFormatStringToHandle(236, 298, GetColor(255, 255, 255), fontHandle[1], "SPACEでスタート");
		DrawFormatStringToHandle(238, 360, GetColor(255, 255, 255), fontHandle[1], "Tでチュートリアル");
	}
